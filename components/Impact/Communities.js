...
function Communities() {
  return (
    <>
         <Container className='text-center community ' fluid> 
       <div className="unique_text">
          <h2>
          Our Impact Extends Beyond These Figures<span style={{ color: "#A6CE41" }}><br/>and Into the Communities We Serve</span>
          </h2> 
          </div>
          </Container>
    <Container className='mt-5'>
        <Row>
        <Col lg={8} className='p-impactstrory '>
            <p className='mb-4'>
            Married for 18 years now, 36-year-old Minta likes to believe in the strategic play of life.
            </p >
            <p className='mb-4'>“Financial difficulty is something that I have always had to live with. I wanted to be a teacher, but my parents, having four children to take care of, forced me to drop out and get married even before I was ready,” she said.</p>
            <p className='mb-4'>But today, Minta works in the sorting unit at Mohammadpur, and her daily responsibilities include sorting good hangers, removing stickers, packing the sorted hangers or breaking the rejected hangers. She earns approximately INR 11,000 per month.</p>
...
Having never believed in a stable job, Sanjay has changed over half a dozen jobs in the past.
            ...
            <p className='mb-4'>“No one treated us like humans. I was always treated like a bonded labourer until I started working in the hanger unit,” he said.</p>
            <p className='mb-4'>36-year-old Sanjay Singh is a migrant resident of Mohammadpur, Gurgaon. Originally from a small town in Aligarh, Uttar Pradesh, Sanjay migrated to the national capital with his wife and two children.</p>
            <p className='mb-4'>“The work culture at the hanger unit is unbelievable compared to my last workplace. Here, I am respected and treated as an equal. Being the line supervisor, I directly manage the immediate workforce. We are all like a family now,” he added.</p>
            <p className='mb-4'>
            ...
            <p className='mb-4'>
            At the unit, Sanjay, being senior among the labourers, is given the role of supervising the work of his fellow workers. As part of his role, he helps other labourers with quality checks, data entry, loading-unloading work and more. </p>
            <p className='mb-4'>For Sanjay, the last two years of unemployment have taught him many lessons on the personal front. Therefore, getting back to work and earning his family some income has brought some peace at his home. Now, he only wishes that this stability continues forever in his life.</p>
        </Col>
        <Col lg={4}>
        <Image
...
A 24-year-old resident of Gulbarga colony, G. Satyavani, counts herself to be a successful mother of two children.
            ...
            <p className='mb-4'>Speaking fondly about the work environment at the unit, Satyavani said, “Everybody in this job speaks nicely to me, even sir.”</p>
    ...
    <div className='container'>
          <div class="border-bottom border-start border-end border-drak p-2  ms-2 me-2"></div>
          </div>
    </>
  )
}
